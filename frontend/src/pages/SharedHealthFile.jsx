            ...
            {data.labels?.map((l) => (
              <div key={l.label} className="rounded-3xl border border-brand-100 bg-white p-6 shadow-sm" data-testid={`shared-label-${l.label}`}>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="text-start text-[10px] font-bold text-slate-500 uppercase tracking-wider border-b border-brand-100">
                      <th className="text-start py-2">Date</th>
                      <th className="text-start py-2">Value</th>
                      <th className="text-start py-2">Ref Range</th>
                    </tr>
                  </thead>
                  <tbody>
